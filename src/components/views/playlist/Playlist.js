...
const TRASH_URL =
  "https://media.istockphoto.com/vectors/trash-cangarbage-canrubbish-bin-icon-vector-id928418914?k=20&m=928418914&s=612x612&w=0&h=hP_RnwBPgcWMJoHqGw9A12vwy5IY3fzfr2dXpx4m6j8=";
  ...
  let [mySongsArr, setmySongsArr] = useState([
    {
      ...
      artist: "Aerosmith",
      album: "Aerosmith",
      ytLink: "https://www.youtube.com/watch?v=89dGC8de0CA",
      delete: TRASH_URL,
    },
    {
      index: 2,
      ...
      album: "Thriller",
      ytLink: "https://www.youtube.com/watch?v=oRdxUFDoQe0",
      delete: TRASH_URL,
    },
    {
      index: 3,
      ...
      ytLink: "https://www.youtube.com/watch?v=fJ9rUzIMcZQ",
      delete: TRASH_URL,
    },
  ]);
